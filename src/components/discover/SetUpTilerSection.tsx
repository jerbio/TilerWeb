...
const UserIcon = () => (
	<IconSvg
		viewBox="0 0 24 24"
		fill="none"
		stroke={palette.colors.brand[400]}
		strokeWidth="2"
		strokeLinecap="round"
...
const SetUpTilerSection: React.FC = () => {
	...
	return (
		<ExpandableWrapper>
			<ExpandableSection>
				<ExpandableHeader $open={setUpOpen} onClick={() => setSetUpOpen((o) => !o)}>
					<ExpandableTextSide>
					...
					<ExpandableHeaderRight>
						<SetUpVisual>
							<SetupRow>
								...
								<SetupRowLabel $done>
									{t('discover.setUpTiler.visual.step1')}
								</SetupRowLabel>
							</SetupRow>
							<SetupRow>
								<SetupDot $done>✓</SetupDot>
								<SetupRowLabel $done>
									{t('discover.setUpTiler.visual.step2')}
								</SetupRowLabel>
							</SetupRow>
							<SetupRow>
								<SetupDot $done>✓</SetupDot>
								<SetupRowLabel $done>
									{t('discover.setUpTiler.visual.step3')}
								</SetupRowLabel>
							</SetupRow>
							<SetupRow>
								<SetupDot $active>◎</SetupDot>
								<SetupRowLabel>
									{t('discover.setUpTiler.visual.step4')}
								</SetupRowLabel>
							</SetupRow>
						</SetUpVisual>
				...
				<ExpandableBody $open={setUpOpen}>
					<ExpandableBodyInner>
						...
						<SetupSupportNote>{t('discover.setUpTiler.supportNote')}</SetupSupportNote>
					</ExpandableBodyInner>
				</ExpandableBody>
			</ExpandableSection>
		</ExpandableWrapper>
