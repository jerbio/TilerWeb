...
const NavigationWrapper = styled(a.nav)<{ $shrink: boolean }>`
	...
	border: ${(props) =>
		props.$shrink ? `1px solid ${pallette.colors.gray[800]}` : '1px solid transparent'};
	background-color: ${(props) => (props.$shrink ? pallette.colors.glass : 'transparent')};
	border-radius: ${(props) => (props.$shrink ? pallette.borderRadius.xxLarge : 0)};
...
const NavLink = styled.a`
	...
	font-family: ${pallette.typography.fontFamily.inter};
...
const MobileNav = styled.div<{ $isopen: boolean; $shrink: boolean }>`
	...
	gap: 16px;
	backdrop-filter: blur(16px);
	background-color: ${(props) => (props.$shrink ? pallette.colors.glass : '#000000')};
	...
	border-radius: ${(props) =>
		props.$shrink ? `0 0 ${pallette.borderRadius.xxLarge} ${pallette.borderRadius.xxLarge}` : 0};
					...
					<NavigationItemsWrapper>
						...
						<ButtonsWrapper>
							<Button
								...
								bordergradient={[pallette.colors.brand[400]]}
							>
