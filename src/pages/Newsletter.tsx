...
const comparisonRows = [
	{
		left: 'You schedule everything manually',
		right: 'AI builds your schedule from plain English',
	},
	{ left: 'No awareness of travel time', right: 'Auto-calculates and adds travel buffers' },
	{
		left: "Static — won't adapt when things change",
		right: 'Detects ripples and reschedules instantly',
	},
	{
		left: 'No navigation or route planning',
		right: 'Navigate your day tile-to-tile with real transit',
	},
	{
		left: 'Shared calendars only — no task assignment',
		right: 'TileShare: assign and track tasks with anyone',
	},
	{
		left: 'Nothing confirmed — events just appear',
		right: 'Confirmation-first — you approve all changes',
	},
];
...
const StepBubble = styled.div<{ $done?: boolean }>`
	...
	height: 32px;
	border-radius: 50%;
	background: ${({ $done }) => ($done ? '#14b8a620' : `${palette.colors.brand[500]}30`)};
	border: 1px solid ${({ $done }) => ($done ? '#14b8a650' : `${palette.colors.brand[500]}50`)};
...
const setupPulse = css`
	@keyframes setupPulse {
		0%,
		100% {
			box-shadow: 0 0 0 0 ${palette.colors.brand[500]}50;
		}
		60% {
			box-shadow: 0 0 0 5px ${palette.colors.brand[500]}00;
		}
	}
`;
...
const SetupDot = styled.div<{ $done?: boolean; $active?: boolean }>`
	...
	animation: ${({ $active }) => ($active ? 'setupPulse 1.8s ease-in-out infinite' : 'none')};
`;
...
const SaTransitOption = styled.div<{ $active: boolean }>`
	...
	border-radius: ${palette.borderRadius.medium};
	border: 1px solid
		${({ $active }) => ($active ? `${palette.colors.brand[500]}40` : palette.colors.gray[700])};
	background: ${({ $active }) =>
		$active ? `${palette.colors.brand[500]}15` : palette.colors.gray[800]};
	font-family: ${palette.typography.fontFamily.inter};
	font-size: 10px;
	text-align: center;
...
const Newsletter: React.FC = () => {
	...
	const whatIsSubItems = [
		{
			...
			content: (
				<SubBodyText>
					When a meeting runs long, or a task gets deferred, Tiler doesn&rsquo;t wait for
					you to fix it. It detects the shift and rebuilds your schedule around it,
					instantly. You set the intent. Tiler handles the rest.
				</SubBodyText>
			),
		},
		{
	...
	const howToItems = howToOrder.map((title) => items.find((i) => i.title === title)!);
			...
			<Section>
				...
				<PageWrapper>
					<Hero>
						...
						<HeroSubtitle>
							Explore the moments where your day finally makes sense. Find your way
							around the app. Find things to try in-app.
						</HeroSubtitle>
					</Hero>
						...
						<ExpandableSection>
							...
							>
								<ExpandableTextSide>
									...
									<SectionTitle>
										Not a calendar. An AI that runs your day
									</SectionTitle>
									<SectionSummary>
										Tell Tiler what needs doing. It finds the time, handles
										conflicts, and adjusts when your day doesn&rsquo;t go to
										plan.
									</SectionSummary>
								</ExpandableTextSide>
						...
						<ExpandableSection>
							...
							>
								<ExpandableTextSide>
									...
									<SectionSummary>
										Your calendar, your preferences, your constraints — four
										steps that give Tiler everything it needs to run Adaptive
							...
							<ExpandableBody $open={setUpOpen}>
								<ExpandableBodyInner>
									<SetupGrid>
										...
										<SetupCard>
											...
											<SetupBody>
												...
												<SetupCardSubtext>
													Sign up with your email — free to start, no
													credit card needed.
												</SetupCardSubtext>
											</SetupBody>
										</SetupCard>
										...
										<SetupCard>
											<SetupAnim>
												<SaCalRow>
													...
													<SaCalCheck $show={calStatus === 'connected'}>
														✓
													</SaCalCheck>
												</SaCalRow>
											</SetupAnim>
											<SetupBody>
												...
												<SetupCardSubtext>
													Link Google or Outlook — Tiler reads your events
										...
										<SetupCard>
											<SetupAnim>
												<SaPrefsScene>
													<SaPrefRow>
														...
														<SaTransitRow>
															<SaTransitOption
																$active={transitMode === 'drive'}
															>
																🚗 Drive
															</SaTransitOption>
															<SaTransitOption
																$active={transitMode === 'transit'}
															>
																🚌 Transit
															</SaTransitOption>
															<SaTransitOption
																$active={transitMode === 'walk'}
															>
																🚶 Walk
															</SaTransitOption>
														</SaTransitRow>
											...
											<SetupBody>
												...
												<SetupCardSubtext>
													Choose your transit mode and set time limits in
													your profile.
												</SetupCardSubtext>
											</SetupBody>
										</SetupCard>
										...
										<SetupCard>
											...
											<SetupBody>
												...
												<SetupCardTitle>
													Ready for Adaptive Scheduling
												</SetupCardTitle>
												<SetupCardSubtext>
													Your schedule is live — Tiler adapts
									...
									<SetupSupportNote>
										Each step is an input to Tiler&rsquo;s scheduling engine —
										your calendar tells it what&rsquo;s fixed, your preferences
										tell it how you move, and your time limits tell it when
										you&rsquo;re free. Together, they give Tiler the full
										picture it needs to run Adaptive Scheduling: a schedule that
										adjusts itself when things change.
									</SetupSupportNote>
								</ExpandableBodyInner>
							</ExpandableBody>
						</ExpandableSection>
						...
						<ExpandableSection>
							...
							>
								<ExpandableTextSide>
									...
									<SectionSummary>
										Connect your calendar, add your tiles, and let Tiler build
										the rest. A step-by-step guide to running your day with
										Tiler.
									</SectionSummary>
								</ExpandableTextSide>
						...
						<ExpandableSection>
							...
							>
								...
								<ExpandableHeaderRight>
									<FeaturesVisual>
										<FeaturesVisualRow>
											<FeaturesVisualIcon $bg="#1A2E3A">
												🧩
											</FeaturesVisualIcon>
											<FeaturesVisualIcon $bg="#3D1C2A">
												🤖
											</FeaturesVisualIcon>
											<FeaturesVisualIcon $bg="#1A2840">
												💬
											</FeaturesVisualIcon>
										</FeaturesVisualRow>
										<FeaturesVisualRow>
											<FeaturesVisualIcon $bg="#4A1A2A">
												🗣️
											</FeaturesVisualIcon>
											<FeaturesVisualIcon $bg="#1A3320">
												🚗
											</FeaturesVisualIcon>
											<FeaturesVisualIcon $bg="#1A2E3A">
												📍
								...
								<ExpandableBodyInner>
									<FeaturesGrid>
										<FeatureCard>
											...
											<FeatureDesc>
												The core unit of Tiler. Each tile is a task, event,
												or habit with a duration — Tiler schedules them
										...
										<FeatureCard>
											...
											<FeatureDesc>
												...
												available time, and builds a complete schedule
												including dependencies — always with your approval
												first.
											</FeatureDesc>
											<FeatureBadge>Core feature</FeatureBadge>
										</FeatureCard>
										...
										<FeatureCard>
											...
											<FeatureDesc>
												...
												dropdowns. Tiler understands context, urgency,
												duration, and location from how you naturally talk.
											</FeatureDesc>
											<FeatureBadge>Core feature</FeatureBadge>
										</FeatureCard>
										...
										<FeatureCard>
											...
											<FeatureDesc>
												...
												distance and transit options. Back-to-back never
												means late.
											</FeatureDesc>
										...
										<FeatureCard>
											...
											<FeatureDesc>
												Link locations to tiles once and Tiler remembers.
												Every time that task appears, travel time is
												calculated automatically from wherever you are.
											</FeatureDesc>
											<FeatureBadge>Unique to Tiler</FeatureBadge>
										</FeatureCard>
										...
										<FeatureCard>
											...
											<FeatureDesc>
												...
												schedules within those bounds. Your personal time
												stays yours — no task bleeds into off-hours unless
												you allow it.
											</FeatureDesc>
										...
										<FeatureCard>
											...
											<FeatureDesc>
												When a meeting runs long or a task gets missed,
												Tiler detects the ripple across your whole day and
												proposes fixes — instantly, with your approval
										...
										<FeatureCard>
											...
											<FeatureDesc>
												...
												existing events and schedules all new tiles around
												them — no double bookings, ever. Supports multiple
												calendars.
											</FeatureDesc>
										...
										<FeatureCard>
											...
											<FeatureDesc>
												Web, iOS, and Android all stay in real-time sync.
												Start a task on your laptop and check in on your
												phone without missing a beat. One schedule,
												everywhere.
											</FeatureDesc>
										...
										<FeatureCard>
											...
											<FeatureDesc>
												...
												finds the next best slot and reschedules with one
												tap. Never lose a task — just push it forward
												intelligently.
											</FeatureDesc>
											<FeatureBadge>Core feature</FeatureBadge>
										</FeatureCard>
										...
										<FeatureCard>
											...
											<FeatureDesc>
												Get alerted when it&rsquo;s time to leave for your
												next tile — with live transit updates if your route
												changes. Never miss a departure time because you
										...
										<FeatureCard>
											...
											<FeatureDesc>
												Share tiles with family or teammates. Assign who
												handles what. Track completion. Everyone&rsquo;s
												calendar adapts around shared commitments
