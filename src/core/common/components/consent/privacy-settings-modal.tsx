	...
	return (
		<Overlay $visible={isOpen} onClick={onClose}>
			<ModalContainer onClick={(e) => e.stopPropagation()}>
				...
				<ModalBody>
					<Description>{t('common.consent.modal.description')}</Description>
					...
					<ConsentSection>
						<ConsentHeader>
							...
							<Toggle
								...
								$disabled={true}
								disabled
								aria-label={t('common.consent.modal.categories.necessary.title')}
							/>
						</ConsentHeader>
						<ConsentDescription>
					...
					<InfoBox>
						...
						<p>
							You can change your preferences at any time. Your choices will be saved
							for future visits. For more information, please read our privacy policy.
						</p>
					</InfoBox>
				</ModalBody>
